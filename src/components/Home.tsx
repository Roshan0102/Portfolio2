...
const Home: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center py-20 bg-transparent relative z-10 transition-colors duration-500 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          className="max-w-6xl mx-auto bg-white/40 dark:bg-gray-900/60 backdrop-blur-xl border border-white/60 dark:border-gray-700/50 rounded-[2rem] md:rounded-[3rem] shadow-2xl overflow-hidden p-6 md:p-12"
        >
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left space-y-6 relative z-20">
              ...
              >
                <span className="inline-block px-4 py-2 rounded-full bg-blue-100/80 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 font-semibold text-sm tracking-wider mb-4 border border-blue-200 dark:border-blue-800/50">
                  👋 WELCOME TO MY PORTFOLIO
                </span>
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight text-gray-900 dark:text-gray-100 mb-2">
                  Hi, I'm <br />
                  <span className="bg-gradient-to-r from-blue-600 via-purple-500 to-blue-600 bg-clip-text pb-2 text-transparent animate-shine">
                    Roshan J
                  </span>
                </h1>
                <h2 className="text-xl md:text-2xl lg:text-3xl font-medium text-gray-600 dark:text-gray-400 flex flex-wrap items-center justify-center lg:justify-start gap-2 md:gap-3">
              ...
              <motion.p
                ...
                className="text-base md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed max-w-xl mx-auto lg:mx-0"
              >
                Architecting secure, scalable AWS environments and automating complex CI/CD workflows.
                Specializing in high-availability Linux infrastructure, seamless deployments, and real-time system observability.
              </motion.p>
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-3 md:px-8 md:py-4 rounded-xl md:rounded-2xl bg-white dark:bg-gray-900 transition-colors text-gray-800 dark:text-gray-200 font-semibold shadow-lg border border-gray-100 dark:border-gray-800 hover:border-purple-200 hover:bg-gray-50 dark:bg-gray-800/80 transition-colors hover:scale-105 transition-all duration-300 flex items-center gap-2 text-sm md:text-base"
                >
                  <GitHubIcon /> GitHub
                </a>
                <a
            ...
            <div className="order-1 lg:order-2 flex justify-center perspective-1000 relative z-20">
              ...
              >
                ...
                {/* Main Image Card */}
                <div
                  className="absolute inset-0 bg-white dark:bg-gray-900 transition-colors rounded-3xl overflow-hidden border-2 border-white/80 dark:border-white/40 shadow-2xl"
                  style={{ transform: 'translateZ(20px)' }}
                >
                  <img
