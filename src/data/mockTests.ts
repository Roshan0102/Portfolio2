...
export const awsCCPQuestions3: Question[] = [
    ...
    },
    {
        ...
        correctAnswer: 2,
        correctAnswers: [2, 3],
        explanation: "Enabling MFA adds an extra layer of security to protect the root user account. It is also recommended to create an IAM user with necessary permissions for daily tasks rather than using the root user to maintain better security and accountability."
    },
    {
        id: 31,
